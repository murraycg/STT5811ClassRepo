...
Use `bat10` to test whether the on base percentate is related to position.
...
2. List the conditions nescessary for performing ANOVA:
  +
  +
  +
...
```{r}
T5N
(0.3354 - 0.3348) +c(-1, 1)*qt(1 - 0.05/(2*choose(7,2)), 320)*sqrt(0.001182)*sqrt(1/33 + 1/39)
```
